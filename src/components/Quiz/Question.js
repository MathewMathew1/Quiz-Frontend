...
const QuestionView = ({ question, index, remainingTime, showTimer=true, userAnswer, showNextButton, lastQuestion, nextQuestion, setFinished}) => {
...
const QuestionEdit = ({index, question,
    ...
    addCategory, deleteCategory, changeDropData, addSuggested, setIsModalOpen, setQuestionBeingDeleted
    }) => {
